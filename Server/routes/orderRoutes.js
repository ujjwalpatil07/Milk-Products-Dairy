...
import { addNewOrder, confirmOrder, getAdminOrders, getAllOrders, getAllUserOrders, rejectOrder } from "../controllers/orderController.js";
...
router.get("/get-admin-orders", wrapAsync(getAdminOrders));
