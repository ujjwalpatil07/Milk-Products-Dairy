        ...
        <form className="flex flex-col items-center w-full" onSubmit={handleFormSubmit}>
          <div className="flex flex-col items-center w-full px-3 gap-2 mb-6">
            <div className="flex justify-between bg-[#D595C3] w-full rounded-lg my-2 p-1">
              ...
              <button className="w-[48%] font-semibold p-1 text-center bg-white rounded-lg">Admin</button>
          ...
          <div className="mt-2 text-center text-sm text-black">
            Are you an admin?{" "}
            <Link to="/admin/login" className="text-[#FF8682] font-medium hover:underline">
              Login here
            </Link>
          </div>
